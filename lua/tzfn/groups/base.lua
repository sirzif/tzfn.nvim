return function(palette, groups, styles, config, make_border)
	return {
		...
		Directory = { fg = palette.grn, bold = styles.bold },
		-- EndOfBuffer = {},
		...
		StatusLine = { fg = palette.grn, bg = groups.panel },
		...
		Visual = { bg = palette.grn_b, blend = 15 },
		-- VisualNOS = {},
		...
		Constant = { fg = palette.mgt },
		Debug = { fg = palette.ylw },
		Define = { fg = palette.grn_b },
		Delimiter = { fg = palette.subtle },
		Error = { fg = palette.red_b },
		Exception = { fg = palette.red_d },
		Float = { fg = palette.ylw },
		Function = { fg = palette.grn },
		Identifier = { fg = palette.fg, italic = styles.italic },
		Include = { fg = palette.grn_b },
		Keyword = { fg = palette.red_b },
		...
		Repeat = { fg = palette.red_d },
		Special = { fg = palette.red },
		SpecialChar = { link = "Special" },
		SpecialComment = { fg = palette.red },
		Statement = { fg = palette.red_d, bold = styles.bold },
		StorageClass = { fg = palette.blu },
		String = { fg = palette.ylw },
		Structure = { fg = palette.blu },
		Tag = { fg = palette.red },
		Todo = { fg = palette.grn, bg = palette.grn_d, blend = 20 },
		Type = { fg = palette.blu },
		TypeDef = { link = "Type" },
